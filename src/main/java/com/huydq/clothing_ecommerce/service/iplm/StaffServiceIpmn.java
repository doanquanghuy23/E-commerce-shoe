...
import com.huydq.clothing_ecommerce.service.StaffService;
...
@Service
public class StaffServiceIpmn implements StaffService {
...
//        user.setFavourite(new Favourite());
    ...
    public String generateRandomString() {
        ...
        return "NV" + randomString.toString();
    }
}
