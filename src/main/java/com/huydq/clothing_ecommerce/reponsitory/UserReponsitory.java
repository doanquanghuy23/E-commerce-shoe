...
public interface UserReponsitory extends JpaRepository<Users, Long> {
    ...
    @Query("select u from Users u where u.role = com.huydq.clothing_ecommerce.entity.Role.CUSTOMER " +
    ...
    @Query("select u from Users u where u.role = com.huydq.clothing_ecommerce.entity.Role.ADMIN " +
            "and (:phoneNumber is null or :phoneNumber = '' or u.phoneNumber like :phoneNumber)")
